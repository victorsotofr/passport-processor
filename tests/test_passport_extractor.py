...
class TestPassportExtractor:
    ...
    def test_convert_df_to_csv(self):
        ...
        df = pd.DataFrame({
            "surname": ["Doe", "Smith"],
            "passport_number": ["A1234567", "B9876543"]
        })
...
class TestExtendAIIntegration:
    ...
    def test_extract_passport_data_success(self, mock_open, mock_spinner, mock_extend):
        ...
        result = extract_passport_data(mock_client, "test_path.pdf", "test_processor_id")
    ...
    @patch('streamlit.error')
    @patch('streamlit.spinner')
    def test_extract_passport_data_failure(self, mock_spinner, mock_st_error, mock_extend):
...
class TestFileHandling:
    ...
    def test_supported_file_extensions(self):
        ...
        for ext in supported_extensions:
            ...
            assert any(filename.lower().endswith(supported_ext.lower()) 
